        ...
        public async Task Process(MessageProcessingContext context, MessageHandlerDelegate next)
        {
            try
            {
                _logger.LogInformation(
                    ...
                    "Command {commandType} will be handled by {handlerType}.",
                ...
                _logger.LogInformation(
                    ...
                    "Command {commandType} will was successfully handled by {handlerType}.",
                    context.Message.GetType().Name,
                    context.Handler?.GetType().Name);
            }
            catch (Exception ex)
            {
                _logger.LogInformation(
                    ...
                    ex,
                    "Processing of command {commandType} resulted with an exception.",
                    context.Message.GetType().Name);
                throw;
            }
        }
